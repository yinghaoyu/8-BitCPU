...
# 在RegisterController的引脚顺序,图里第0位弃用了
MSR = 1
MAR = 2
MDR = 3
RAM = 4
...
# 指令的标识
ADDR2 = 1 << 7 # 二地址指令, 0b1xxxxxxx
ADDR1 = 1 << 6 # 一地址指令, 0b01xxxxxx

ADDR2_SHIFT = 4
ADDR1_SHIFT = 2

# Addresing Mode
# IR共8位,其中0~1表示源操作数AM,2~3表示目的操作数AM,5~8位表示操作类型
AM_INS = 0 # 立即数寻址
AM_REG = 1 # 寄存器寻址
AM_DIR = 2 # 直接寻址
AM_RAM = 3 # 寄存器间接寻址
